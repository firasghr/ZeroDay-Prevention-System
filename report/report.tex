...
\fancyhead[R]{\small Zero-Day Prevention System}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
  ...
  {\Large\bfseries\color{deepblue} University Name}\\[0.4cm]
  {\large Faculty of Computer Science and Engineering}\\[0.2cm]
  {\large Department of Cybersecurity}\\[2.5cm]

  \rule{\linewidth}{1.5pt}\\[0.6cm]
  {\LARGE\bfseries Design and Implementation of a\\[0.3cm]
   Zero-Day Attack Prevention System}\\[0.6cm]
  \rule{\linewidth}{1.5pt}\\[2cm]

  {\large Capstone Project Report\\
   Submitted in Partial Fulfilment of the Requirements\\
   for the Degree of Bachelor of Science in Cybersecurity Engineering}\\[2.5cm]

  \begin{tabular}{rl}
    \textbf{Author:}        & Firas Ghr \\[4pt]
    \textbf{Supervisor:}    & Prof.\ [Supervisor Name] \\[4pt]
...
Detection and Response (EDR) tool implemented entirely in Python.
